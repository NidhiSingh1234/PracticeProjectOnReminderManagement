...
/**
 * Servlet implementation class SetReminder
 */
public class SetReminder extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int i=ReminderDao.save(bean);
		if(i>0){
			System.out.println("<h3>Reminder saved successfully</h3>");
